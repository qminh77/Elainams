    ...
    run: async function(client, message, args, user) {
        try {
            ...
            let help = new MessageEmbed()
                .setColor('YELLOW')
                .setAuthor('Elaina | Mời tớ:3', client.user.avatarURL({ dynamic: true }), `https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=6479507312`)
